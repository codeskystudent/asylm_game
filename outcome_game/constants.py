...
# World size (pixels) — layout in arena_navigation.ARENA_WALLS matches this scale
ARENA_W = 2700.0
ARENA_H = 1800.0
...
ROUND_SECONDS = 300.0
# Exit zones: open after this fraction of the *initial* round has elapsed (last 25% of timer)
ESCAPE_OPENS_AT_ROUND_FRACTION = 0.75
...
DROP_DASH_BOUNCE_DISTANCE = 52.0
...
METAL_CHARGE_DURATION_SECONDS = 10.0
...
X2011_GRAB_BOT_ESCAPE_PER_SECOND = 20.0
...
KILLER_STUN_KNOCKBACK_DISTANCE = 34.0
...
KOLLOSIOS_BASIC_GRAB_THROW_SPEED = 780.0
